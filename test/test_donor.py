...
def test_donor_bad_phonenumber():
    ...
    test_donor = Donor(donor_name = "Zavala", telephone_number = "111122223333123", want_receipt = False)
    test_donor.save()
...
def test_invalid_postal_code():
    test_donor = Donor(donor_name = "Kobayashi", postal_code = "12345678123afasdf", want_receipt = False)
    test_donor.save()
