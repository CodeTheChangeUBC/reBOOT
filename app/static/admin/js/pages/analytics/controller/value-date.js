...
define(["../analytics-util", "../graph/line-graph", "../constants"], function(util, LineGraph, c) {
  ...
  function ValueDateController(elementId, keyName, valueName, startDate, endDate, graphOption) {
  ...
  ValueDateController.prototype.updateGraph = function(startDate, endDate) {
    var self = this;
  ...
  ValueDateController.prototype.getKeysAndValues = function() {
    var self = this;
