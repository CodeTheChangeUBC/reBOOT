...
urlpatterns = [
    ...
    url(r'^add/get_donation_data$', views.get_donation_data, name='get_donation_data'),
    url(r'^add/get_items$', views.get_items, name='get_items'),
    url(r'^add/get_donation_data$', views.get_donation_data, name='get_item_data'),
