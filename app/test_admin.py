...
class ItemInlineTestCase(TestCase):
    ...
    def test_get_readonly_fields(self) -> None:
        ...
        self.assertTupleEqual(tuple1=got_readonly_fields, tuple2=())
...
class ItemAdminTestCase(TestCase):
    ...
    def test_destroy_item(self) -> None:
        ...
        self.item_admin.destroy_item(req=request, qs=queryset)

        try:
            got_item = Item.objects.get(donation=self.donation)
