...
def parser(csvfile):
	...
	'''
    def getCreateDonor(donor_name_f, email_f, want_receipt_f, telephone_number_f,
                       mobile_number_f, address_line_f, city_f, province_f, postal_code_f, customer_ref_f):

        want_receipt_f = "email" in want_receipt_f.lower(
        ) or "e-mail" in want_receipt_f.lower()
	...
	Returns nothing
	'''
    def addItem(donation_f, description_f, particulars_f, manufacturer_f,
                model_f, quantity_f, working_f, condition_f, quality_f, batch_f, value_f):
