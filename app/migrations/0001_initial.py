# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-02-17 19:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pick_up', models.CharField(blank=True, max_length=30, verbose_name='Pick-Up Postal')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('province', models.CharField(choices=[('AB', 'Alberta'), ('BC', 'British Columbia'), ('ON', 'Ontario'), ('NS', 'Nova Scotia'), ('NL', 'Newfoundland and Labrador'), ('SK', 'Saskatchewan'), ('YT', 'Yukon'), ('MB', 'Manitoba'), ('NU', 'Nunavut'), ('PE', 'Prince Edward Island'), ('NT', 'Northwest Territories'), ('QC', 'Quebec'), ('NB', 'New Brunswick')], max_length=20, verbose_name='Province')),
                ('postal_code', models.CharField(max_length=7, verbose_name='Postal Code')),
                ('customer_ref', models.CharField(blank=True, max_length=20, verbose_name='Customer Ref.')),
                ('verified', models.BooleanField(default=False, verbose_name='D & I Verified?')),
            ],
        ),
        migrations.CreateModel(
            name='Item',
            fields=[
                ...
                ('value', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=10, verbose_name='Value')),
