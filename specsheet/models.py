...
class RefurbishedItem(models.Model):
    ...
    storage_type = models.CharField("Storage type", max_length=200, choices=storage_type_choices, null=True, default=None)

    screen_size = models.IntegerField("Screen size (inches)", null=True, default=None)
    screen_port = models.CharField("Screen port", max_length=200, choices=screen_port_choices, null=True, default=None, blank=True)

    audio_features = models.CharField("Audio features", max_length=200, choices=audio_feature_choices, null=True, default=None)
    ...
    LAN_type = models.CharField("LAN type", max_length=200, choices=LAN_type_choices, null=True, default=None)

    installed_apps = models.CharField("Pre-installed apps", max_length=200, choices=installed_apps_choices, null=True, default=None, blank=True)
